...
//
// YAxisSeriesInfoProvider.swift is part of SCICHART®, High Performance Scientific Charts
...
class YAxisSeriesInfoProvider: SCIDefaultAxisInfoProvider {
    ...
    override func getAxisTooltipInternal(_ axisInfo: SCIAxisInfo, modifierType: AnyClass) -> ISCIAxisTooltip {
        if modifierType == CrosshairModifier.self {
            return YAxisTooltip(axisInfo: axisInfo)
        } else {
