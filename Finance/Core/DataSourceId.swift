...
//
// DataSourceId.swift is part of SCICHART®, High Performance Scientific Charts
...
public class DataSourceId: NSObject {
    ...
    public static func uniqueId(studyId: StudyId, name: String) -> DataSourceId {
        return DataSourceId(id: "\(studyId):\(name)")
    }
